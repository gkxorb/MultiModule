...
public class SpringConfig {
     ...
     */
    @Autowired
    public SpringConfig(@Qualifier("H2DataSource")DataSource H2DataSource, @Qualifier("MsSQLDataSource")DataSource SqlDataSource/*, @Qualifier("h2EntityManager") EntityManager entityManager*/ ) {
